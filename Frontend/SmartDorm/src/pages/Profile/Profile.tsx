      ...
      >
        ...
        <main
          ...
          style={{
            paddingLeft: "20px",
            paddingRight: "20px",
            background: "linear-gradient(180deg, #f6f1fc 0%, #ffffff 100%)",
          }}
        >
...
================================================================ */
  ...
  function ProfileCard({
    ...
    return (
      <>
        <div className="d-flex justify-content-center align-items-start align-items-md-center min-vh-75">
          <div className="card profile-card shadow-lg px-2 py-3 w-100">
            <h4
